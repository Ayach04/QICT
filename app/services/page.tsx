...
const services = [
  ...
  },
  {
    ...
    shortDescription: 'Contrôle du temps de travail et gestion des accès avec badge ou biométrie.',
  },
  {
    id: 'reseau',
    image: '/images/services/network.jpg',
    title: 'Installation Réseau',
    shortDescription: 'Mise en place et maintenance  d’une infrastructure réseau fiable et performante.',
  },
  {
    id: 'migration',
    image: '/images/services/migration.jpg',
    title: 'Migration et déploiement logiciels',
    shortDescription: 'Déploiement de logiciels métiers et gestion de la migration.',
  },
  {
    id: 'formation',
    image: '/images/services/formation.jpg',
    title: 'Formation et accompagnement',
    shortDescription: 'Formations pour vos équipes sur les outils numériques & logiciels.',
  },
  {
    id: 'crm-erp',
  ...
  },
  {
    ...
    shortDescription: 'Creation des sites web et hebergement sur internet, en respectant vos besoins.',
  },
  {
    id: 'vente',
    image: '/images/services/vente1.png',
    title: 'Vente des équipements et des solutions IT/électronique',
    shortDescription: 'Assistance technique rapide, maintenance préventive et corrective.',
  },
  {
    id: 'caisse',
